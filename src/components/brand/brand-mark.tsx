...
export function BrandMark({ className }: { className?: string }) {
  return (
    <Link href="/" className={cn("group inline-flex items-center gap-2.5", className)} aria-label="NEET Prep home">
      <span className="relative grid size-9 place-items-center overflow-hidden rounded-[11px] bg-slate-950 text-white shadow-[0_8px_20px_rgba(15,23,42,0.18)]">
      ...
      <span className="font-display text-lg font-bold tracking-[-0.03em] text-slate-950">NEET<span className="text-emerald-700">Prep</span></span>
    </Link>
  );
}
