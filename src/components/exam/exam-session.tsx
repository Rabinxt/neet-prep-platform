      ...
      <header className="sticky top-0 z-40 border-b border-white/10 bg-slate-950 text-white shadow-lg">
        <Container className="flex min-h-16 items-center justify-between gap-3 py-2">
          ...
          <div className="flex shrink-0 items-center gap-2 sm:gap-4">
            <div className={cn("rounded-xl border px-3 py-2 text-center", remainingSeconds <= EXAM_LOW_TIME_WARNING_SECONDS ? "border-rose-400/50 bg-rose-500/15 text-rose-200" : "border-white/15 bg-white/[0.07] text-white")} aria-label={`${formatCountdown(remainingSeconds)} remaining`}>
